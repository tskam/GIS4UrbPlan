...
-   performing flying distance analysis using QGIS vector-based GIS analysis function,
...
![](img11/image1.jpg){width="35%"}

-   For **Grid extend:**, select *Calculate from Layer* -\> `mpsz`

![](img11/image2.jpg){width="55%"}
...
## Accessibility Analysis with Vector-based GIS Analysis

In this section, you will perform the following tasks:

- computing flying distance between hexagon centroids and eldercare centres, and 
- creating choropleth map for visualising the geographic accessibility to eldercare centre.
...
![](img11/image19.jpg){width="55%"}

-   Scroll down and select *filled_arrowhead* marker.

![](img11/image20.jpg){width="35%"}
