---
title: "GIS Mapping and Geovisualisation"
date: "10/30/2022"
...
• Navigate to \Hands-on_Ex03\DataTables sub folder.
...
In this section, you will learn how to use QGIS **Print Layout** platform to create a land use map for printing or publishing purposes. Before getting started, we assume that already have the following two choropleth maps on the QGIS project:

-   population age 65+, 2020, and
-   total population, 2020.

Both choropleth maps are based on URA Master Plan Subzone 2019 boundary.
...
![](img03/image56.jpg){width="250"}

-   Provide the layout an appropriate title such as *Population*.
...
-   From the **Item Properties** panel, look for **Main Properties** then enter `350000` as *Scale* value. (Note: Use other rounding values deem appropriate for your layout)

![](img03/image62.jpg){width="350"}
...
![](img03/image70.jpg){width="350"}

Notice that the right grid reference disappeared.

![](img03/image71.jpg)

> DIY: Repeat the step you learned to turn off the top grid reference.

The map layout should look similar to the screenshot below.

![](img03/image72.jpg)

Next, we will keep the coordinates value in whole number instead of number with three decimal places.

-   Look for **Coordinate precision** on **Draw Coordinates** pane, change the default value (i.e. 3) to 0 as shown on the screenshot below.

![](img03/image73.jpg){width="420"}
...
Since this layout will focus on Population Age 65+ , we are going to remove other unrelated items from the legend.

-   From **Legend Items** sub-panel, click on the check-box in front of *Only show items inside linked map*.

![](img03/image78.jpg){width="300"}

Notice that the unrelated legend items disappeared from the legend as shown in the screenshot below.
...
![](img03/image93.jpg){width="400"}

The print layout should look similar to the screenshot below.

![](img03/image94.jpg)

-   Lastly, remember to click on the Save ![](img03/image95.jpg){width="30" height="30"} button to save the layout.

### Exporting print layout

In QGIS, the composed map layout can be exported into three formats, namely: Image, SVG and PDF.

-   To export, click on **Layout** from the menu bar and select on of the format list below.

![](img03/image96.jpg){width="244"}

We are coming to the end of the hands-on exercise. Please be reminded that we are just scratching the surface so far. The **Layout** of QGIS provides many more functions for your to prepare cartography quality and yet high elegent map layout to meet your reporting and presentation need. You are encouraged to explore the rest of the functions as much as you can.
